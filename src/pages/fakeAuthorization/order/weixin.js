        ...
        <>
            <div className="orderBox">
                ...
                <div>
                    ...
                    <div className="item describe">温馨提示：微信支付分达到550分及以上，免押金领取机器；领取期间不收取押金，您需在收货后30日内激活设备，不激活将通过微信支付分扣取机器押金<span className="num">{amount}</span>元。</div>
            ...
            <Modal
                ...
                style={{ width:350}}
                >
                <div className={"scroll"} style={{height:400}}>
